module LocalDependency.Data.Monoid.Alternate where

import Prelude

import LocalDependency.Control.Alternative (class Alt, class Plus, class Alternative, empty, (<|>))
import LocalDependency.Control.Comonad (class Comonad, class Extend)
