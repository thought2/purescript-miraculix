module LocalDependency.Data.Functor.Flip where

import Prelude

import LocalDependency.Control.Biapplicative (class Biapplicative, bipure)
import LocalDependency.Control.Biapply (class Biapply, (<<*>>))
import LocalDependency.Data.Bifunctor (class Bifunctor, bimap, lmap)
import LocalDependency.Data.Functor.Contravariant (class Contravariant)
