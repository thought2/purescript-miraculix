module LocalDependency.Data.Functor.Product2 where

import Prelude

import LocalDependency.Control.Biapplicative (class Biapplicative, bipure)
import LocalDependency.Control.Biapply (class Biapply, biapply)
import LocalDependency.Data.Bifunctor (class Bifunctor, bimap)
import LocalDependency.Data.Profunctor (class Profunctor, dimap)
