module LocalDependency.Data.Maybe.First where

import Prelude

import LocalDependency.Control.Extend (class Extend)
import LocalDependency.Control.MonadZero (class MonadZero, class Alternative, class Plus, class Alt)
import Data.Eq (class Eq1)
import LocalDependency.Data.Functor.Invariant (class Invariant)
