module LocalDependency.Data.Profunctor.Star where

import Prelude

import LocalDependency.Control.Alt (class Alt, (<|>))
import LocalDependency.Control.Alternative (class Alternative)
import LocalDependency.Control.MonadPlus (class MonadPlus)
import LocalDependency.Control.MonadZero (class MonadZero)
import LocalDependency.Control.Plus (class Plus, empty)

import LocalDependency.Data.Distributive (class Distributive, distribute, collect)
import LocalDependency.Data.Either (Either(..), either)
import LocalDependency.Data.Functor.Invariant (class Invariant, imap)
import Data.Newtype (class Newtype)
import LocalDependency.Data.Profunctor (class Profunctor)
import LocalDependency.Data.Profunctor.Choice (class Choice)
