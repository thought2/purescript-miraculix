module LocalDependency.Data.Functor.App where
...
import LocalDependency.Control.Comonad (class Comonad)
import LocalDependency.Control.Extend (class Extend)
import LocalDependency.Control.Lazy (class Lazy)
import LocalDependency.Control.MonadPlus (class MonadZero, class MonadPlus)
import LocalDependency.Control.Plus (class Plus)
